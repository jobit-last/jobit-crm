...
export default function JobsPagination({ total, page, perPage, totalPages }: JobsPaginationProps) {
        ...
        {getPageNumbers().map((p) => (
          <button
            ...
            className={`px-3 py-1 rounded text-sm border transition-colors ${
              p === page ? "bg-primary text-white border-primary" : "border-secondary hover:bg-secondary"
            }`}
          >
            {p}
          </button>
