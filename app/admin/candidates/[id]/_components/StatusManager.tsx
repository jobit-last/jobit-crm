...
export default function StatusManager({ candidateId, currentStatus, histories }: Props) {
      ...
      <form onSubmit={handleSubmit}>
        <div className="flex items-end gap-3">
          <div className="flex-1">
            ...
            <div className="mb-3">
              <span
                className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium ${STATUS_COLORS[currentStatus]}`}
              >
              ...
              <li key={h.id} className="ml-4">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  {h.from_status ? (
                    <>
                      <span
                        className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${STATUS_COLORS[h.from_status]}`}
                      >
                  ...
                  <span
                    className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${STATUS_COLORS[h.to_status]}`}
                  >
