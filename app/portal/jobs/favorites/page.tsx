    ...
    <div style={{ backgroundColor: "#F2F6FF", minHeight: "100vh" }}>
      <div className="max-w-5xl mx-auto px-4 py-10">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-2xl font-bold mb-1" style={{ color: "#16B1F3" }}>
              お気に入り求人
            </h1>
          ...
          {compareIds.length > 0 && (
            <Link
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold text-white hover:opacity-80 transition-opacity shadow-md"
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl shadow-sm py-20 text-center">
            <div
              ...
              style={{ background: GRADIENT_B }}
            >
              <span className="text-3xl" style={{ color: MINT }}>♡</span>
            </div>
            <p className="text-sm text-gray-500 mb-2">お気に入りがありません</p>
