    ...
    <div className="max-w-5xl mx-auto px-4 py-10">
      ...
      <div className="text-center mb-12">
        <span
          ...
          style={{ backgroundColor: "#E6FBF7", color: MINT }}
        >
          学習コンテンツ
        </span>
        ...
        <div className="flex justify-center gap-4 mt-5">
          <Link
            ...
            className="text-sm font-medium px-5 py-2 rounded-xl border-2 transition-colors hover:bg-teal-50"
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 mb-10">
        <p className="text-xs font-semibold text-gray-400 mb-3">職種一覧</p>
        <div className="flex flex-wrap gap-2">
          {JOB_ROLES.map((r) => (
            <a
              key={r.id}
              href={`#${r.id}`}
              className="text-xs font-medium px-3 py-1.5 rounded-full border transition-colors hover:text-white"
              style={{
                borderColor: r.color,
                color: r.color,
              }}
              onMouseEnter={(e) => {
                (e.currentTarget as HTMLAnchorElement).style.backgroundColor = r.color;
      ...
      <div className="space-y-8">
        {JOB_ROLES.map((role) => (
          ...
          >
            ...
            <div
              className="px-6 py-5"
              style={{ backgroundColor: role.color + "0f", borderBottom: `2px solid ${role.color}20` }}
            >
            ...
            <div className="px-6 py-5 space-y-5">
              ...
              <div className="pt-2 border-t border-gray-50">
                <Link
                  ...
                  className="inline-flex items-center gap-2 text-xs font-semibold px-4 py-2 rounded-xl text-white transition-opacity hover:opacity-80"
